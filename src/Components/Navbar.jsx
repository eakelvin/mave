    ...
    <div>
        <div className="container-fluid bg-dark px-5">
            <div className="row gx-0">
                <div className="col-lg-8 col-md-8 col-sm-8 text-center text-lg-start mb-2 mb-lg-0">
                    <div className="d-inline-flex align-items-center" style={{height: "45px"}}>
                        <small className="me-3 text-light"><BiFootball size={25} />Mave Sports</small>
                        <small className="me-3 text-light"><IoMail size={20} />mavesports@gmail.com</small>
                    </div>
                </div>
                <div className="col-lg-4 col-md-4 col-sm-4 text-center text-lg-end">
        ...
        <nav className="navbar bg-primary navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
            <div className="container">
                <Link to='/' className="navbar-brand">
                    <img src='./logo/photo_3.jpg' width={60} height={60} />
                </Link>
